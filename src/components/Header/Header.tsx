...
import logoBank from "../../../public/assets/logo.png";
...
export function Header() {
  ...
  return (
    <MotionTransition>
      <nav className="flex flex-wrap items-center justify-between max-m-5xl p-4 mx-auto">
        <Link href="/" className="flex items-center">
          <Image src={logoBank} alt="Logo Bank" width={150} priority={true} />
        </Link>
        <RiMenu3Line
